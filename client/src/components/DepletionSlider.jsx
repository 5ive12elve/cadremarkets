...
export default function DepletionSlider() {
  ...
  return (
    <div ref={sliderRef} className="relative w-full bg-black" dir={isArabic ? 'rtl' : 'ltr'}>
      ...
      <button
        onClick={() => paginate(-1)}
        className={`absolute ${isArabic ? 'right-3 md:right-4' : 'left-3 md:left-4'} top-[30%] md:top-[30%] -translate-y-1/2 group p-3 md:p-4 bg-black/30 backdrop-blur-sm rounded-full hover:bg-black/50 transition-all duration-300 transform hover:scale-110 flex items-center z-40`}
      >
        {isArabic ? 
      ...
      <button
        onClick={() => paginate(1)}
        className={`absolute ${isArabic ? 'left-3 md:left-4' : 'right-3 md:right-4'} top-[30%] md:top-[30%] -translate-y-1/2 group p-3 md:p-4 bg-black/30 backdrop-blur-sm rounded-full hover:bg-black/50 transition-all duration-300 transform hover:scale-110 flex items-center z-40`}
      >
