...
const StatusDistributionChart = ({ data, loading = false }) => {
    ...
    return (
      <div className="bg-black border border-[#db2b2e]/20 p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-gray-400 text-sm uppercase tracking-wider">Status Distribution</h3>
        </div>
  ...
  return (
    ...
    >
      <h3 className="text-gray-400 text-sm uppercase tracking-wider mb-6">Status Distribution</h3>
