  ...
  const fetchStatistics = async () => {
    try {
      ...
      if (isBackofficeAuthenticated()) {
        response = await backofficeApiRequest(`/support/backoffice/statistics?timeframe=${timeframe}`);
      } else {
        response = await fetch(`/api/support/backoffice/statistics?timeframe=${timeframe}`);
      }
